...
for index, row in df.iterrows():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Step 8: Apply noise reduction using GaussianBlur
            img_np = cv2.GaussianBlur(img_np, (5, 5), 0)  # (5,5) is the kernel size; adjust it for stronger blur

            # Alternative: Use median filtering to remove noise
